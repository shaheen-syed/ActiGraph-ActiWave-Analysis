...
def load_yaml(file = None):
	...
	Parameters
	----------
	file : os.path (optional)
		location of yml file. if not provided, use default config.yml
	"""

	# if file not provided, use default
	if file is None:
		file = 'config.yml'
...
def get_subject_counters_for_correction(subject):
	...
	subject_counter_to_correct = {	'90086831' : [0,1,2,3,4,5,6,7],
									...
									'90232925' : [1], # 1-2
									'90239124' : [24], # 23-24
									'90242017' : [8,9,10,11,12,13,14,15,16], # 8-18
									'90244423' : [37],
									'90245424' : [2],
									'90249024' : [0,1],
									'90261927' : [0],
									'90279027' : [0],
									'90287430' : [0], # 0-1
									'90319123' : [12,14], # 11-14
									'90334524' : [11],
									'90345122' : [0,1], # 0-1
									'90359733' : [35,36], # 35-37
									'90362525' : [0],
									'90364224' : [0],
									'90389837' : [10,11], # 10-11
									'90392124' : [0,1,13],
									'90409325' : [0],
									'90413825' : [11], # 11-12
									'90414422' : [15],
									'90423321' : [18,20], # 18-20
									'90447125' : [0,1],
									'90470020' : [2],
									'90537529' : [0,1], #0-1
									'90543223' : [1],
									...
									'90819330' : [20],
									'90923225' : [1,3], # 0-2
									'90925328' : [20], # 20-21 *check
									'90984939' : [0],
									'91187935' : [14],
									'91633729' : [14],
									'91643427' : [11], # 11-12
									'92150421' : [13, 15], # 14-15
									'92191527' : [19], # 18-19
									'92237730' : [18],
									'92680530' : [3],
									'93192832' : [20],
	...
	# not picked up on some nw time
	# 90365124



def get_subject_counter_to_merge(subject):

	subject_counter_to_merge = {
								'90042823' : (6,7),
								'90086831' : (0,7),
								'90173929' : (0,1),
								'90233320' : (8,9),
	...
	# return counters to merge, if not part of dictionary, then it returs None; meaning no correction to apply
	return subject_counter_to_merge.get(subject)
